...
struct EmailVerificationScreen: View {
    ...
    var body: some View {
        ...
        GeometryReader { geo in
            ...
            let hintSize = min(max(screenWidth * 0.035, 12.5), 14)
            ...
            ZStack {
                ...
                VStack(spacing: 0) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text(
                            "We sent a verification link to your email address. Open your inbox, tap the link, then come back here."
                        )
