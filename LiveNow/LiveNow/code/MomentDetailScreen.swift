                ...
                ScrollView(showsIndicators: false) {
                    VStack(spacing: 24) {
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            Text("Every time you choose action over overthinking, you build a stronger, calmer mind.")
                                .font(.system(size: bodySize))
                                .foregroundColor(.gray)
                                .fixedSize(horizontal: false, vertical: true)
                        }
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            ImpactRow(text: "You broke the loop before it took over", iconSize: impactIconSize)
                            ImpactRow(text: "You chose presence over worry", iconSize: impactIconSize)
                            ImpactRow(text: "You moved forward instead of staying stuck", iconSize: impactIconSize)
                        }
                        .padding()
                        .frame(maxWidth: .infinity, alignment: .leading)
                        .background(Color.white.opacity(0.6))
